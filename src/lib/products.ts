...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Gothic Chaos Cyber Boxy Tee",
    price: 1199,
    image: teeBackModel,
    gallery: [
      teeBackModel,
    ...
    isNew: true,
    sku: "NV-2026-TE02",
    shortDescription: "280 GSM heavyweight combed cotton with raw edge neckline, high-density gothic dragon back artwork, and red typography embroidery.",
    description:
      "The definitive gothic streetwear tee. Cut from dense 280 GSM single jersey cotton with drop shoulders and wide sleeves. Features signature hand-distressed raw neck trim, intricate multi-layer red and silver dragon embroidery across the back, and metallic puff-screenprinted gothic chest lettering.",
    details: [
      "280 GSM dense 100% bio-washed combed single jersey cotton",
      "Signature high-density multi-color dragon embroidery & screenprint backpiece",
      "Hand-distressed raw cut collar with reinforced neck tape",
      "3D raised red gothic chest embroidery lettering",
      "Drop-shoulder boxy streetwear cut with wide elbow-length sleeves",
      "Double needle hem stitching for long-lasting durability",
      "Tailored for unisex styling (true to size for oversized silhouette)",
    ],
    washcare: [
      "Cold machine wash inside-out (delicate/gentle cycle, 30°C)",
      "Do not scrub or iron embroidery and print areas directly",
      "Dry flat or hang dry in shade to preserve artwork intensity",
      "Do not dry clean or use chlorine bleach",
    ],
    shippingInfo: [
      "Ready to ship: Dispatches within 24 hours from Mumbai studio",
      "Delivered in 2–4 business days with live SMS/WhatsApp tracking",
      "7-day hassle-free exchange & returns policy",
      "Free express shipping pan-India on prepaid orders",
    ],
    sizes: ["S", "M", "L", "XL", "XXL"],
    soldOutSizes: [],
    colors: [
